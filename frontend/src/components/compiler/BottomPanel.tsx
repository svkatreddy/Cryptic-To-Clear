      ...
      <div className="flex items-center justify-between px-4 py-2 border-b border-[var(--border)] shrink-0 bg-[var(--panel)]">
        <div className="flex items-center gap-1.5">
          <button
            ...
            className={`px-3 py-1 text-[13px] font-medium rounded-md transition-colors flex items-center gap-1.5 cursor-pointer ${activeTab === "output"
          ...
          <button
            ...
            className={`px-3 py-1 text-[13px] font-medium rounded-md transition-colors flex items-center gap-1.5 cursor-pointer ${activeTab === "stdin"
                ? "bg-[var(--bg)] text-[var(--ink)] shadow-sm font-semibold"
                : "text-[var(--ink-dim)] hover:text-[var(--ink)]"
              }`}
          >
          ...
          {errors && (
            <button
              ...
              className={`px-3 py-1 text-[13px] font-medium rounded-md transition-colors flex items-center gap-1.5 cursor-pointer ${activeTab === "errors"
