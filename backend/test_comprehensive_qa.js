...
const FEATURE_TESTS = [
  ...
  },
  {
    category: "If-Else Statements",
    lang: "cpp",
    code: `#include <iostream>\nint main() { int val = 15; if(val > 10) std::cout << "Greater" << std::endl; else std::cout << "Smaller" << std::endl; return 0; }`,
    stdin: "",
    expectOut: "Greater",
  },
  {
    category: "Loops (for, while)",
    lang: "cpp",
    code: `#include <iostream>\nint main() { for(int i=0;i<3;i++) std::cout << i << " "; std::cout << std::endl; return 0; }`,
    stdin: "",
    expectOut: "0 1 2",
  },
  {
    ...
    lang: "cpp",
    code: `#include <iostream>\n#include <vector>\nint main() { std::vector<int> v = {4, 5, 6}; std::cout << "v.size=" << v.size() << std::endl; return 0; }`,
    stdin: "",
    expectOut: "v.size=3",
  },
  {
    category: "Functions",
    lang: "cpp",
    code: `#include <iostream>\nint multiply(int a, int b) { return a * b; }\nint main() { std::cout << multiply(3, 7) << std::endl; return 0; }`,
    stdin: "",
    expectOut: "21",
  },
  {
    category: "Recursion",
    lang: "cpp",
    code: `#include <iostream>\nint fib(int n) { if(n<=1) return n; return fib(n-1) + fib(n-2); }\nint main() { std::cout << "fib6=" << fib(6) << std::endl; return 0; }`,
    stdin: "",
    expectOut: "fib6=8",
  },
  {
    ...
    lang: "cpp",
    code: `#include <iostream>\nclass Box { public: int w; Box(int width): w(width){} };\nint main() { Box b(12); std::cout << "Box w=" << b.w << std::endl; return 0; }`,
    stdin: "",
    expectOut: "Box w=12",
  },
  {
    category: "File Handling Simulation",
    lang: "cpp",
    code: `#include <iostream>\nint main() { std::cout << "CPP File Stream Ready" << std::endl; return 0; }`,
    stdin: "",
  ...
  },
  {
    ...
    lang: "cpp",
    code: `#include <iostream>\nint main() { try { throw 404; } catch(int e) { std::cout << "Caught exception " << e << std::endl; } return 0; }`,
    stdin: "",
  ...
  },
  {
    ...
    lang: "cpp",
    code: `#include <iostream>\n#include <algorithm>\n#include <vector>\nint main() { std::vector<int> v={3,1,2}; std::sort(v.begin(), v.end()); for(int x: v) std::cout<<x<<" "; std::cout << std::endl; return 0; }`,
    stdin: "",
    expectOut: "1 2 3",
  },
  {
    ...
    lang: "cpp",
    code: `#include <iostream>\n#include <algorithm>\n#include <vector>\nint main() { std::vector<int> v={10,20,30}; std::cout << std::binary_search(v.begin(), v.end(), 20) << std::endl; return 0; }`,
    stdin: "",
    expectOut: "1",
  },
  {
    category: "Large Loops (Performance)",
    lang: "cpp",
    code: `#include <iostream>\nint main() { long long count=0; for(int i=0;i<5000;i++) count++; std::cout << "Count=" << count << std::endl; return 0; }`,
    stdin: "",
